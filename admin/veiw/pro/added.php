         ...
         <div class="col-lg-12">
             <section class="panel">
                 ...
                 <div class="panel-body">
                     <div class="form">
                         <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" enctype="multipart/form-data" action="index.php?c=pro&a=add">
                             <div class="form-group ">
                                 <label for="name" class="control-label col-lg-2">عنوان</label>
                                 <div class="col-lg-10">
                                     <input class=" form-control" id="name" name="frm[name]" type="text">
                                 </div>
                             </div>
                             <div class="form-group ">
                             ...
                             <div class="form-group ">
                                 ...
                                 <div class="col-lg-10">
                                     <input class=" form-control" id="price" name="frm[price]" type="text">
                                 </div>
                             </div>
                             <div class="form-group ">
                                 <label for="detials" class="control-label col-lg-2">تعداد</label>
                                 <div class="col-lg-10">
                                     <input class=" form-control" id="detials" name="frm[count]" type="text-area">
                                 </div>
                             </div>
                             <div class="form-group ">
                                 <label for="detials" class="control-label col-lg-2">توضیحات</label>
                                 <div class="col-lg-10">
                                     <input class=" form-control" id="detials" name="frm[detials]" type="text-area">
                                 </div>
                             </div>
                             <div class="form-group">
