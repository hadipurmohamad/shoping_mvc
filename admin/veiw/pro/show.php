                           ...
                           <?php foreach ($res as $key => $value) : ?>
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <a href='index.php?c=pro&a=edit&id=<?php echo $value['id']; ?>'> <button class='btn btn-success btn-xs'><i class='icon-pencil'></i></button></a>
                                       <a href='index.php?c=pro&a=delete&id=<?php echo $value['id']; ?>'> <button class='btn btn-success btn-xs'><i class='icon-trash'></i></button></a>
                                   </td>
                               </tr>
