...
<div class="row">
    ...
    <div class="small-12 small-centered medium-4 medium-uncentered large-4 large-uncentered product-thumb columns">
        ...
        <div class="product-main-photo">
            <img class="p-photo" src="<?php echo "admin/temp_image/$procatDetial[image1]"; ?>" data-large="img/products/product-large.jpg" alt="Product Main Thumb" style="visibility: visible;">
        </div>
        <!-- End product main photo -->
        <!-- Product Thumb Gallery  -->
        <div class="thumb-gallery" dir="ltr">
            <div id="carousel-gallery" style="opacity: 1; display: block;" class="owl-carousel owl-theme">
                <div class="owl-wrapper-outer">
                    <div class="owl-wrapper" style="width: 1022px; left: 0px; display: block; transition: all 800ms ease 0s; transform: translate3d(-73px, 0px, 0px);">
                        <div class="owl-item" style="width: 73px;">
    ...
    <div class="small-12 small-centered medium-5 medium-uncentered large-5 large-uncentered product-description columns">
        ...
        <div class="product-detail-title">
            <?php echo $procatDetial['tittle']; ?>
        </div>
        <!-- End Title -->
        <!-- Description -->
        <div class="product-detail-description">
            <?php echo $procatDetial['detials']; ?>
        </div>
        <!-- End Description -->
        <!-- Border -->
        ...
        <div class="small-12 small-centered medium-5 medium-uncentered large-6 q-lineheight large-uncentered columns">
            <div class="main-price"><span>$ <?php echo $procatDetial['price']; ?></span><?php echo $procatDetial['price']; ?></div>
        </div>
        <!-- End Product Price -->
        <!-- Add To Cart -->
    ...
    <div class="small-12 small-centered medium-3 medium-uncentered large-3 large-uncentered product-left-module columns">
        ...
        <div class="bst-seller-list">
            <div class="bst-seller-thumb">
                <img src="<?php echo "admin/temp_image/$value[image1]";  ?>" alt="thumbnail1" />
            </div>
            <div class="bst-seller-content">
                <div class="bst-seller-title"><a href="#" title="turtle neck"> <?php echo $value['tittle'];  ?> </a></div>
